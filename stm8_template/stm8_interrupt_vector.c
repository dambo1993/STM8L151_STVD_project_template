...
struct interrupt_vector const _vectab[] = {
  ...
  {0x82, (interrupt_handler_t)EXTI7_IRQHandler},
  /* irq16 - LCD / AES interrupt */      			
  {0x82, (interrupt_handler_t)LCD_AES_IRQHandler}, 
  /* irq17 - CLK switch/CSS interrupt/ TIM1 Break interrupt / DAC */    			
  {0x82, (interrupt_handler_t)SWITCH_CSS_BREAK_DAC_IRQHandler},
  /* irq18 - ADC1 and Comparator interrupt */ 
  {0x82, (interrupt_handler_t)ADC1_COMP_IRQHandler},
  ...
  {0x82, (interrupt_handler_t)TIM2_CC_USART2_RX_IRQHandler},
  /* irq21 - TIM3 Update/Overflow/Trigger/Break / USART3 TX interrupt */    
  {0x82, (interrupt_handler_t)TIM3_UPD_OVF_TRG_BRK_USART3_TX_IRQHandler},
  /* irq22 - TIM3 Capture/Compare /USART3 RX interrupt */      
  {0x82, (interrupt_handler_t)TIM3_CC_USART3_RX_IRQHandler},
  /* irq23 - TIM1 Update/Overflow/Trigger/Commutation interrupt */	
  {0x82, (interrupt_handler_t)TIM1_UPD_OVF_TRG_COM_IRQHandler},
  /* irq24 - TIM1 Capture/Compare interrupt */ 
  {0x82, (interrupt_handler_t)TIM1_CC_IRQHandler},  
  /* irq25 - TIM4 Update/Overflow/Trigger interrupt */    		
  {0x82, (interrupt_handler_t)TIM4_UPD_OVF_TRG_IRQHandler}, 
  /* irq26 - SPI1 interrupt */    
  {0x82, (interrupt_handler_t)SPI1_IRQHandler},
  /* irq27 - USART1 TX / TIM5 Update/Overflow/Trigger/Break interrupt */     			
  {0x82, (interrupt_handler_t)USART1_TX_TIM5_UPD_OVF_TRG_BRK_IRQHandler}, 
  /* irq28 - USART1 RX / TIM1 Capture/Compare interrupt */     
  {0x82, (interrupt_handler_t)USART1_RX_TIM5_CC_IRQHandler}, 
  /* irq29 - I2C1 / SPI2 interrupt */   
  {0x82, (interrupt_handler_t)I2C1_SPI2_IRQHandler},     		
};
